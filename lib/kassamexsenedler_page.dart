import 'dart:convert';
import 'package:aliyev_apk/main.dart' show globalIp, globalPort;
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:intl/intl.dart';
import 'main.dart' show globalIp, globalPort, globalAllowDateChange, globalTermname,globalceki, globaleded;

class KassaMexaricDocPage extends StatefulWidget {
  const KassaMexaricDocPage({super.key});

  @override
  State<KassaMexaricDocPage> createState() => _KassaMexaricDocPageState();
}

class _KassaMexaricDocPageState extends State<KassaMexaricDocPage> {
  bool _loading = true;
  String? _error;
  ...
  Future<void> _loadHeaders() async {
    ...
    final url = Uri.parse(
        '$base/kassamexaricdoc?userId=$globalTermname&start=${DateFormat('yyyy-MM-dd').format(_startDate)}&end=${DateFormat('yyyy-MM-dd').format(_endDate)}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Kassa Məxaric Sənədləri")),
      body: Column(
        children: [
          _buildDateFilters(),
          Expanded(
