...
class BalanshesPage extends StatefulWidget {
  const BalanshesPage({super.key});

  @override
  State<BalanshesPage> createState() => _BalanshesPageState();
}

class _BalanshesPageState extends State<BalanshesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Balans hesabatı'),
