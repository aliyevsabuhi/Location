...
class SifarisPage extends StatefulWidget {
  const SifarisPage({super.key});

  @override
  State<SifarisPage> createState() => _SifarisPageState();
}

class _SifarisPageState extends State<SifarisPage> {
  ...
  Future<void> _loadLookups() async {
    ...
    try {
      ...
      setState(() {
        ...
        // Seçimlər boşdursa, default olaraq ilk elementi seç
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (resp.statusCode >= 200 && resp.statusCode < 300) {
        ...
        if (!mounted) return;
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Sifariş sənədi təsdiqləndi')),
